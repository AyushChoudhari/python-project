...
db = mysql.connector.connect(host ="localhost",user = "root",password = '@daniel22',database='database')
cursor = db.cursor()
 
window=Tk()
window.title("Books Management System")
 
greet = Label(window, font = ('arial', 30, 'bold'), text = "Lovely Professional University!")
